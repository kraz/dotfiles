...
# Detect distro and set Nerd Font icon for starship prompt
...
[[ -d "$HOME/lib/maven/bin" ]]    && export PATH="$HOME/lib/maven/bin:$PATH"
[[ -d "$HOME/.symfony5/bin" ]]    && export PATH="$HOME/.symfony5/bin:$PATH"
